  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 md:gap-10 rounded-md border border-black p-[5px] md:p-[8px] text-zinc-700 text-sm shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] outline-none transition-all focus:translate-x-[3px] focus:translate-y-[3px] focus:shadow-none"
      >
        Search doc...
