...
export default function Sidebar() {
  ...
  return (
    <aside className="scrollbar fixed top-20 h-[calc(100vh-80px)] max-h-[calc(100vh-80px)] w-[303px] bg-[#7db3ff] overflow-y-auto border-r-4 border-black">
      ...
      {components.map((item, index) => (
        <Link key={index} href={`/docs/components/${item.name}`} className={`block border-black p-4 pl-7 text-base hover:bg-[#63d0ff] ${
